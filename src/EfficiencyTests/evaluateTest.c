...
int main()
{
    ...
    comparEvaluate(fileResultsDegreeHalf,fileResultsDegree1,fileResultsDegree0, 0);
    ...
    comparEvaluate(fileResultsCoeffsHalf,fileResultsCoeffs1,fileResultsCoeffs0,1);
